...
(function () {
  ...
  angular
      ...
      .constant('events', Object.freeze({
        ...
        SCM_REPOSITORY_CREATION_ERROR: 'SCM_REPOSITORY_CREATION_ERROR',

        NEW_ANNOUNCEMENT: 'NEW_ANNOUNCEMENT',
        MAINTENANCE_MODE_ON: 'MAINTENANCE_MODE_ON',
        MAINTENANCE_MODE_OFF: 'MAINTENANCE_MODE_OFF',
        PNC_SYSTEM_VERSION_CHANGE: 'PNC_SYSTEM_VERSION_CHANGE',

        BUILD_PUSH_STATUS_CHANGE: 'BUILD_PUSH_STATUS_CHANGE',

        BUILD_CONFIG_UPDATED: 'BUILD_CONFIG_UPDATED',

        MILESTONE_PUSH_STATUS_CHANGE: 'MILESTONE_PUSH_STATUS_CHANGE',
